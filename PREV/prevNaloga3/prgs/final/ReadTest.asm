...
L11	SET	$0,8
	...
	TRAP	0,Fputs,StdOut
	%	 --- Epilogue ---
L12	STO	 $0,FP,0  % Save return value 
	%	 Highering Stack pointer 
	SET	 SP,FP
	%	 Getting RA 
	SET	 $0,16
...
_readString	SET	 $0,16
	...
	SUB	 SP,SP,$0
	JMP	 L13
L13	LDA	$255,ReadArgs
	SET	$0,$255
	TRAP	0,Fgets,StdIn
	%	 --- Epilogue ---
L14	STO	 $0,FP,0  % Save return value 
	%	 Highering Stack pointer 
	SET	 SP,FP
	%	 Getting RA 
	SET	 $0,16
...
_putInt_Print_out_end	JMP	L16	%	 --- Epilogue ---
L16	STO	 $0,FP,0  % Save return value 
	%	 Highering Stack pointer 
	SET	 SP,FP
	%	 Getting RA 
	SET	 $0,32
