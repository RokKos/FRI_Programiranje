...
L9	SET	 $0,0
	...
	STO	 $1,$0,0
	JMP	 L10
L11	SWYM	0,4,2 %Two labels one after another
L10	SET	 $1,$253
	SET	 $0,8
	NEG	 $0,0,$0
	SET	 $0,$0
...
L16	SET	 $0,1
	...
	STO	 $2,$0,0
	JMP	 L17
L18	SWYM	0,4,2 %Two labels one after another
L17	SET	 $1,$253
	SET	 $0,8
	NEG	 $0,0,$0
	SET	 $0,$0
...
_putInt_Print_out_end	JMP	L32	%	 --- Epilogue ---
